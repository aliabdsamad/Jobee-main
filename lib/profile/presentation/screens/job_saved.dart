      ...
      body:SafeArea(
        child: Column(
          children: [
                  ...
                  Container(
                    ...
                    child: CircleAvatar(
                     ...
                     // backgroundColor:Colors.cyan ,
                      backgroundImage:AssetImage(AssetsPath.finalcv ,
            ...
            Column(
              children: [
                Text("Cairo, Egypt, (on site), Part Time",
                  style: TextStyle(fontSize:16 ,
                      height: 1.5,
                      fontWeight: FontWeight.w500,
                      fontFamily: 'Montserrat',
                ...
                Text("3 weeks ago • Over 100 applicants . 8 connections",
