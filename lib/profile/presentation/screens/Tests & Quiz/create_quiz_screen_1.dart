        ...
        body: Column(
         // mainAxisAlignment: MainAxisAlignment.end,
          ...
          children: [
                              ...
                              child: Container(
                               ...
                               // width: 70,
                                child: CircleAvatar(
                                  ...
                                  backgroundImage:AssetImage('assets/face1.jpeg',
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Padding(
                            padding: const EdgeInsets.all(8.0),
                            child: Image.asset(AssetsPath.o,height: 16,width: 16,),
                          ),
            ...
            SizedBox(height: 19,),
            Center(
              child: Text("You Have 5 Tasks Today !",
                style: TextStyle(fontSize:16 ,
                    height: 1.5,
                    fontWeight: FontWeight.w600,
                    fontFamily: 'Montserrat',
            ...
            Padding(
              ...
              child: CustomButton(
                onTap: ()=> Navigator.pushNamed(context, CreateQuiz2Screen.id),
                text: 'Continue',
