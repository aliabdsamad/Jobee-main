          ...
          child: Stack(
                ...
                child: Container(
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      fit: BoxFit.fill,
                      image:AssetImage( 'assets/face1.jpeg',
            ...
            Padding(
              ...
              child: DropdownButtonFormField(
                  ...
                  items:const [
                    DropdownMenuItem(child: Text('UI UX'),value: 'UIUX',),
                    DropdownMenuItem(child: Text('Flutter'),value: 'Flutter',),
                    DropdownMenuItem(child: Text('Frontend'),value: 'Frontend',),
           ...
           // SizedBox(height:16 ,),
                ...
                Padding(
                  ...
                  child: DropdownButtonFormField(
                      ...
                      items:const [
                        DropdownMenuItem(child: Text('Fresh'),value: 'Fresh',),
            ...
            Padding(
              ...
              child: DropdownButtonFormField(
                  ...
                  items:const [
                    ...
                    DropdownMenuItem(child: Text('Exempt'),value: 'Exempt',),
                    DropdownMenuItem(child: Text('Delayed'),value: 'Delayed',),
                    DropdownMenuItem(child: Text('He terminated the service'),value: 'He terminated the service',),
                  ],
                  onChanged:dropdowncallback),
            ),
            SizedBox(height: 16,),
            Padding(
              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  //label: Text('Skills'),
                  labelText:'About you' ,
                  hintText: "Hi Iam Abdallah Ui Ux designer ,I specialize in creating\n"
